...
class SpeechToText:
    ...
    def _resample_audio(
        self, waveform: Tensor, original_sample_rate: int
    ) -> tuple[Tensor, int]:
    ...
    def run(self) -> str:
        ...
        resampled_waveform, new_sample_rate = self._resample_audio(
